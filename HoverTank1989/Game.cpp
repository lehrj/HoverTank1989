...
void Game::Initialize(HWND window, int width, int height)
{
  ...
  // m_listener.pCone = const_cast<X3DAUDIO_CONE*>(&c_listenerCone);
    ...
    */
    ...
    m_terrainGamePlayLightsOn.environType = EnvironmentType::ENVIRONMENTTYPE_GAMEPLAY_LIGHTS_ON;
    result = InitializeTerrainArrayNew(m_terrainGamePlayLightsOn);
    if (!result)
    {
        isInitSuccessTrue = false;
    }
...
bool Game::InitializeTerrainArrayNew(Terrain& aTerrain)
{
    ...
    for (int i = 0; i < aTerrain.terrainVertexCount; ++i)
    {
        ...
        */
        ...
        if (i > m_spawnerTerrainFadeStartRow2Spawn1 && i < m_spawnerTerrainFadeEndRow2Spawn1)
        {
            //aTerrain.terrainVertexArrayBase[i].color = DirectX::XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
        }

        DirectX::XMFLOAT4 spawnerPatchColor = baseColor;
        if (aTerrain.environType == EnvironmentType::ENVIRONMENTTYPE_GAMEPLAY_LIGHTS_ON)
        {
            spawnerPatchColor = m_spawnerColorTerrainPatch;
        }
...
void Game::CreateDeviceDependentResources()
{
    ...
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy02.png", nullptr, m_textureFinDeploy02.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy02.png", nullptr, m_normalMapFinDeploy02.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy02.png", nullptr, m_specularFinDeploy02.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy03.png", nullptr, m_textureFinDeploy03.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy03.png", nullptr, m_normalMapFinDeploy03.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy03.png", nullptr, m_specularFinDeploy03.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy04.png", nullptr, m_textureFinDeploy04.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy04.png", nullptr, m_normalMapFinDeploy04.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy04.png", nullptr, m_specularFinDeploy04.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy05.png", nullptr, m_textureFinDeploy05.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy05.png", nullptr, m_normalMapFinDeploy05.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy05.png", nullptr, m_specularFinDeploy05.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy06.png", nullptr, m_textureFinDeploy06.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy06.png", nullptr, m_normalMapFinDeploy06.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy06.png", nullptr, m_specularFinDeploy06.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy07.png", nullptr, m_textureFinDeploy07.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy07.png", nullptr, m_normalMapFinDeploy07.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy07.png", nullptr, m_specularFinDeploy07.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy08.png", nullptr, m_textureFinDeploy08.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy08.png", nullptr, m_normalMapFinDeploy08.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy08.png", nullptr, m_specularFinDeploy08.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy09.png", nullptr, m_textureFinDeploy09.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy09.png", nullptr, m_normalMapFinDeploy09.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy09.png", nullptr, m_specularFinDeploy09.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy10.png", nullptr, m_textureFinDeploy10.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy10.png", nullptr, m_normalMapFinDeploy10.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy10.png", nullptr, m_specularFinDeploy10.ReleaseAndGetAddressOf()));

    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/Textures/textFinDeploy11.png", nullptr, m_textureFinDeploy11.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/NormalMaps/normFinDeploy11.png", nullptr, m_normalMapFinDeploy11.ReleaseAndGetAddressOf()));
    DX::ThrowIfFailed(CreateWICTextureFromFile(device, L"../HoverTank1989/Art/SpecularMaps/specularFinDeploy11.png", nullptr, m_specularFinDeploy11.ReleaseAndGetAddressOf()));
    ...
    // Spawners
    m_shapeNormCube = DirectX::GeometricPrimitive::CreateBox(context, DirectX::SimpleMath::Vector3(1.0f, 1.0f, 1.0f));
    m_shapeNormCylinder = DirectX::GeometricPrimitive::CreateCylinder(context, 1.0f, 1.0f);
    m_shapeNormCylinderGear = DirectX::GeometricPrimitive::CreateCylinder(context, 1.0f, 1.0f, m_shapeGearCount);
    m_shapeNormCylinderAxel = DirectX::GeometricPrimitive::CreateCylinder(context, m_shapeAxelHeightScale, m_shapeAxelDiameterScale, m_spawnerAxelShaftSideCount);

    const float spawnerHeight = m_spawnerDimensions.y;
    const float spawnerDiameter = m_spawnerDimensions.x;
    const float spawnerThickness = m_spawnerShellThickness;
    const float spawnerScale = m_spawnerScale;
    const int spawnerSides = m_spawnerSides;
    m_spawnerOuterShape = DirectX::GeometricPrimitive::CreateTorus(context, spawnerDiameter, spawnerThickness, spawnerSides);
    ...
    m_spawnerInnerBackShadowMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerInnerBackShadowMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerInnerBackShadowMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerPos - m_spawnerShadowOffset, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);
    m_spawnerInnerBackShadowMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerInnerBackShadowMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerInnerBackShadowMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerPos2 + m_spawnerShadowOffset, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);
    // shell interior
    m_spawnerShellInteriorMat1 = DirectX::SimpleMath::Matrix::Identity;

    auto archShadowTrans1 = DirectX::SimpleMath::Vector3(0.0f, 0.0f, 0.0f);
    DirectX::SimpleMath::Matrix archShadowMat1 = DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(0.93f, 0.99f, 0.93f));
    archShadowMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(archShadowTrans1);
    archShadowMat1 *= m_spawnerOuterMat;
    m_spawnerShellInteriorMat1 = archShadowMat1;

    DirectX::SimpleMath::Matrix archShadowMat2 = DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(0.93f, 0.99f, 0.93f));
    auto archShadowTrans2 = DirectX::SimpleMath::Vector3(0.0f, 0.0f, 0.0f);
    archShadowMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(archShadowTrans2);
    archShadowMat2 *= m_spawnerOuterMat2;
    m_spawnerShellInteriorMat2 = archShadowMat2;
    ...
    m_spawnerAxelShape3 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelDimensions3.x, m_spawnerAxelDimensions3.y, 5);

    m_spawnerAxelShaftShape = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelShaftDimensions.x, m_spawnerAxelShaftDimensions.y, m_spawnerAxelShaftSideCount);
    ...
    m_spawnerBaseBlastMat1 = m_spawnerBaseMat1;
    m_spawnerBaseBlastMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(0.0f));
    m_spawnerBaseMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerBasePos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    ...
    m_spawnerBaseBlastMat2 = m_spawnerBaseMat2;
    ...
    // base roof
    const float roofLeanAngle = Utility::ToRadians(2.5f);
    ...
    m_spawnerBaseRoofMat1 *= DirectX::SimpleMath::Matrix::CreateRotationZ(roofLeanAngle);
    m_spawnerBaseRoofMat1 *= DirectX::SimpleMath::Matrix::CreateRotationY(Utility::ToRadians(0.0f));
    m_spawnerBaseRoofMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerRoofPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    ...
    m_spawnerBaseRoofMat2 *= DirectX::SimpleMath::Matrix::CreateRotationZ(roofLeanAngle);
    ...
    m_spawnerBlastWindowBarPortMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerBlastWindowBarPortMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerBlastWindowBarDimensions);
    m_spawnerBlastWindowBarPortMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerBlastWindowAngle);
    m_spawnerBlastWindowBarPortMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerBlastWindowOffsetX, m_spawnerBlastWindowOffsetY, m_spawnerBlastWindowOffsetZ));
    m_spawnerBlastWindowBarPortMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerLowerPos1, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerBlastWindowBarStarMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerBlastWindowBarStarMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerBlastWindowBarDimensions);
    m_spawnerBlastWindowBarStarMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerBlastWindowAngle);
    m_spawnerBlastWindowBarStarMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(-m_spawnerBlastWindowOffsetX, m_spawnerBlastWindowOffsetY, m_spawnerBlastWindowOffsetZ));
    m_spawnerBlastWindowBarStarMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerLowerPos1, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerBlastWindowBarPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerBlastWindowBarPortMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerBlastWindowBarDimensions);
    m_spawnerBlastWindowBarPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(-m_spawnerBlastWindowAngle);
    m_spawnerBlastWindowBarPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerBlastWindowOffsetX, m_spawnerBlastWindowOffsetY, -m_spawnerBlastWindowOffsetZ));
    m_spawnerBlastWindowBarPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerLowerPos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerBlastWindowBarStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerBlastWindowBarStarMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerBlastWindowBarDimensions);
    m_spawnerBlastWindowBarStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(-m_spawnerBlastWindowAngle);
    m_spawnerBlastWindowBarStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(-m_spawnerBlastWindowOffsetX, m_spawnerBlastWindowOffsetY, -m_spawnerBlastWindowOffsetZ));
    m_spawnerBlastWindowBarStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerLowerPos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);
    ...
    m_spawnerBaseRearMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerBaseRearMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerRearScale);
    m_spawnerBaseRearMat1 *= DirectX::SimpleMath::Matrix::CreateRotationY(Utility::ToRadians(90.0f));
    m_spawnerBaseRearMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(DirectX::SimpleMath::Vector3(m_spawnerRearPos2.x, m_spawnerRearPos2.y, -m_spawnerRearPos2.z), DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    //////////////////

    m_spawnerMainAxelMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerMainAxelMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerMainAxelMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerMainAxelMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerMainAxelMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerMainAxelMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // gearbox;
    m_spawnerGearBoxMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerGearBoxMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawneGearboxDimensions);
    m_spawnerGearBoxMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerGearboxPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerGearBoxMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerGearBoxMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawneGearboxDimensions);
    ...
    m_spawnerLightHousingMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(m_spawnerLightingCenterTrans);
    m_spawnerLightHousingMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerBasePos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerLightHousingMat1Pos2 = m_spawnerLightHousingMat1Pos1;
    m_spawnerLightHousingMat1Pos3 = m_spawnerLightHousingMat1Pos1;
    m_spawnerLightHousingMat1Pos4 = m_spawnerLightHousingMat1Pos1;

    m_spawnerLightHousingMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 1.5f, 0.0f, 0.0f));
    m_spawnerLightHousingMat1Pos2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 0.5f, 0.0f, 0.0f));
    m_spawnerLightHousingMat1Pos3 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * -0.5f, 0.0f, 0.0f));
    m_spawnerLightHousingMat1Pos4 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * -1.5f, 0.0f, 0.0f));


    m_spawnerLightInnerMat1Pos1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerLightInnerMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerLightInnerDimensions);
    m_spawnerLightInnerMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateRotationZ(m_spawnerLightAngle);
    m_spawnerLightInnerMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(m_spawnerLightInnerOffset);
    m_spawnerLightInnerMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(m_spawnerLightingCenterTrans);
    m_spawnerLightInnerMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerBasePos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerLightInnerMat1Pos2 = m_spawnerLightInnerMat1Pos1;
    m_spawnerLightInnerMat1Pos3 = m_spawnerLightInnerMat1Pos1;
    m_spawnerLightInnerMat1Pos4 = m_spawnerLightInnerMat1Pos1;

    m_spawnerLightInnerMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 1.5f, 0.0f, 0.0f));
    m_spawnerLightInnerMat1Pos2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 0.5f, 0.0f, 0.0f));
    m_spawnerLightInnerMat1Pos3 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * -0.5f, 0.0f, 0.0f));
    m_spawnerLightInnerMat1Pos4 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * -1.5f, 0.0f, 0.0f));

    // 2
    m_spawnerLightHousingMat2Pos1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerLightHousingMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerLightHousingDimensions);
    m_spawnerLightHousingMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateRotationZ(m_spawnerLightAngle);
    m_spawnerLightHousingMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(m_spawnerLightingCenterTrans);
    m_spawnerLightHousingMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateRotationY(Utility::ToRadians(180.0f));
    m_spawnerLightHousingMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerBasePos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerLightInnerMat2Pos1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerLightInnerDimensions);
    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateRotationZ(m_spawnerLightAngle);
    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(m_spawnerLightInnerOffset);
    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(m_spawnerLightingCenterTrans);
    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateRotationY(Utility::ToRadians(180.0f));
    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerBasePos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerLightHousingMat2Pos2 = m_spawnerLightHousingMat2Pos1;
    m_spawnerLightHousingMat2Pos3 = m_spawnerLightHousingMat2Pos1;
    m_spawnerLightHousingMat2Pos4 = m_spawnerLightHousingMat2Pos1;

    m_spawnerLightHousingMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 1.5f, 0.0f, 0.0f));
    m_spawnerLightHousingMat2Pos2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 0.5f, 0.0f, 0.0f));
    m_spawnerLightHousingMat2Pos3 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * -0.5f, 0.0f, 0.0f));
    m_spawnerLightHousingMat2Pos4 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * -1.5f, 0.0f, 0.0f));

    m_spawnerLightInnerMat2Pos2 = m_spawnerLightInnerMat2Pos1;
    m_spawnerLightInnerMat2Pos3 = m_spawnerLightInnerMat2Pos1;
    m_spawnerLightInnerMat2Pos4 = m_spawnerLightInnerMat2Pos1;

    m_spawnerLightInnerMat2Pos1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 1.5f, 0.0f, 0.0f));
    m_spawnerLightInnerMat2Pos2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(m_spawnerLightingSpacing * 0.5f, 0.0f, 0.0f));
    ...
    // light ring
    m_spawnerLightRingShape = DirectX::GeometricPrimitive::CreateTorus(context, m_spawnerLightHousingDimensions.x - (m_spawnerLightingRingThickness * 1.0f), m_spawnerLightingRingThickness);
    m_spawnerLightRingMat1Pos1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerLightRingMat1Pos1 *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(1.0f, m_spawnerLightingRingScale, 1.0f));
    ...
    // spawner lighting
    m_spawnerLightDirection1 = DirectX::SimpleMath::Vector3::UnitY;
    m_spawnerLightDirection1 = DirectX::SimpleMath::Vector3::Transform(m_spawnerLightDirection1,
        DirectX::SimpleMath::Matrix::CreateRotationX(-m_spawnerLightAngle));

    m_spawnerLightDirection2 = DirectX::SimpleMath::Vector3::UnitY;
    m_spawnerLightDirection2 = DirectX::SimpleMath::Vector3::Transform(m_spawnerLightDirection2,
        DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerLightAngle));

    // dual gear housing
    m_shapeGearbox = DirectX::GeometricPrimitive::CreateBox(context, m_spawneGearboxDimensionsDual);
    m_spawnerGearBoxPortMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerGearBoxPortMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerGearboxOffsetX, m_spawnerGearboxOffsetY, -m_spawnerGearboxOffsetZ));
    m_spawnerGearBoxPortMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerGearBoxStarMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerGearBoxStarMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerGearboxOffsetX, m_spawnerGearboxOffsetY, m_spawnerGearboxOffsetZ));
    m_spawnerGearBoxStarMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerGearBoxPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerGearBoxPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerGearboxOffsetX, m_spawnerGearboxOffsetY, -m_spawnerGearboxOffsetZ));
    m_spawnerGearBoxPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerGearBoxStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerGearBoxStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerGearboxOffsetX, m_spawnerGearboxOffsetY, m_spawnerGearboxOffsetZ));
    m_spawnerGearBoxStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // dual axels
    m_spawnerMainAxelShape = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerMainGearDimensions.x, m_spawnerMainGearDimensions.y, 8);
    m_spawnerMainAxelCoreShape = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerMainGearDimensions.x * 1.05f, m_spawnerMainGearDimensions.y, 3);

    m_spawnerAxelDualShape2 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight2, m_spawnerAxelDiameter2, 8);
    m_spawnerAxelCoreDualShape2 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight2 * 1.05f, m_spawnerAxelDiameter2, 3);

    m_spawnerAxelDualShape3 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight3, m_spawnerAxelDiameter3, 8);
    m_spawnerAxelCoreDualShape3 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight3 * 1.05f, m_spawnerAxelDiameter3, 3);

    m_spawnerMainGearPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    //   m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
     //      DirectX::SimpleMath::Vector3(m_spawnerMainGearOffsetX, m_spawnerMainGearOffsetY, -m_spawnerMainGearOffsetZ));
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(0.0f, 0.0f, -m_spawnerMainGearOffsetZ));
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerMainGearStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    //  m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
    //      DirectX::SimpleMath::Vector3(m_spawnerMainGearOffsetX, m_spawnerMainGearOffsetY, m_spawnerMainGearOffsetZ));
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(0.0f, 0.0f, m_spawnerMainGearOffsetZ));
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // dual axel 2
    m_spawnerAxelDualShape2 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight2, m_spawnerAxelDiameter2, 8);
    m_spawnerAxelCoreDualShape2 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight2 * 1.05f, m_spawnerAxelDiameter2 * 0.7f, 3);

    m_spawnerSecondGearPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerSecondGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerSecondGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, -m_spawnerMainGearOffsetZ));
    m_spawnerSecondGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerSecondAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerSecondGearStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerSecondGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerSecondGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, m_spawnerMainGearOffsetZ));
    m_spawnerSecondGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerSecondAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    // dual axel 3
    m_spawnerAxelDualShape3 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight3, m_spawnerAxelDiameter3, 5);
    m_spawnerAxelCoreDualShape3 = DirectX::GeometricPrimitive::CreateCylinder(context, m_spawnerAxelHeight3 * 1.05f, m_spawnerAxelDiameter3 * 0.6f, 3);

    m_spawnerThirdGearPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerThirdGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerThirdGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, -m_spawnerMainGearOffsetZ));
    m_spawnerThirdGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerThirdAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerThirdGearStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerThirdGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerThirdGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, m_spawnerMainGearOffsetZ));
    m_spawnerThirdGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerThirdAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // extender gear housing
    m_spawnerExtenderHousePortMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderHousePortMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendHousingDimensions);
    m_spawnerExtenderHousePortMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerExtendHousingOffsetX, m_spawnerExtendHousingOffsetY, -m_spawnerExtendHousingOffsetZ));
    m_spawnerExtenderHousePortMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderHouseStarMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderHouseStarMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendHousingDimensions);
    m_spawnerExtenderHouseStarMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerExtendHousingOffsetX, m_spawnerExtendHousingOffsetY, m_spawnerExtendHousingOffsetZ));
    m_spawnerExtenderHouseStarMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderHousePortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderHousePortMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendHousingDimensions);
    m_spawnerExtenderHousePortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerExtendHousingOffsetX, m_spawnerExtendHousingOffsetY, -m_spawnerExtendHousingOffsetZ));
    m_spawnerExtenderHousePortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderHouseStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderHouseStarMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendHousingDimensions);
    m_spawnerExtenderHouseStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerExtendHousingOffsetX, m_spawnerExtendHousingOffsetY, m_spawnerExtendHousingOffsetZ));
    m_spawnerExtenderHouseStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // extender gear
    m_spawnerExtenderGearStarMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendGearScale);
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerExtendGearOffsetX, m_spawnerExtendGearOffsetY, -m_spawnerExtendGearOffsetZ));
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
...
void Game::CalculateSpawnerData()
{
    auto closedVec = -DirectX::SimpleMath::Vector3::UnitZ;
    auto overCloseVec = closedVec;
    auto openVec = closedVec;
    openVec = DirectX::SimpleMath::Vector3::Transform(openVec, m_spawnerDoorOpenQuat);
    overCloseVec = DirectX::SimpleMath::Vector3::Transform(overCloseVec, DirectX::SimpleMath::Quaternion::CreateFromAxisAngle(
        DirectX::SimpleMath::Vector3::UnitX, Utility::ToRadians(-80.0f)));
    DirectX::SimpleMath::Vector3 compVec1 = DirectX::SimpleMath::Vector3::UnitY;
    ////////////////////////////////////////
    float angle1 = Utility::ToRadians(0.0f);
    float ratio1 = 0.0f;
    float quatAngle1 = 0.0f;
    auto currQuat = DirectX::SimpleMath::Quaternion::Identity;
    float ang = 0.0f;
    DirectX::SimpleMath::Vector3 stepVec1 = -DirectX::SimpleMath::Vector3::UnitZ;
    float smoothAng1 = 0.0f;

    m_debugData->ToggleDebugOnOverRide();
    //m_isSpawnerLightOn1 = false;
    float blastShieldRatio1 = 0.0f;
    if (m_isSpawnerDoorActive1 == true)
    {
        const float timerRatio = m_spawnerDoorTimer1 / m_spawnerDoorSwingTimeMax;
        if (timerRatio > 0.45f && timerRatio < 0.55f)
        {
        ...
        {
            ratio1 = ((m_spawnerDoorTimer1 - closeStartTime) / (m_spawnerDoorSwingTimeMax - closeStartTime));
            ratio1 = 1.0f - ratio1;
    ...
    if (m_isSpawnerDoorActive1 == true)
    {
        ...
        float closeStartTime = m_spawnerDoorSwingTimeMax * 0.9f;
    ...
    DirectX::SimpleMath::Quaternion mainAxelQuat1 = DirectX::SimpleMath::Quaternion::CreateFromAxisAngle(DirectX::SimpleMath::Vector3::UnitX, angle1);
    DirectX::SimpleMath::Quaternion mainAxelQuatUpdate1 = DirectX::SimpleMath::Quaternion::Slerp(m_spawnerMainAxelQuat1, mainAxelQuat1, ratio1);

    /////////////
    // Spawner 2
    /////////////
    float angle2 = 0.0f;
    float quatAngle2 = 0.0f;
    float ratio2 = 0.0f;
    ...
    float blastShieldRatio2 = 0.0f;
    //m_isSpawnerLightOn2 = false;
    if (m_isSpawnerDoorActive2 == true)
    {
        const float timerRatio = m_spawnerDoorTimer2 / m_spawnerDoorSwingTimeMax;
        if (timerRatio > 0.3f && timerRatio < 0.65f)
        {
        ...
        {
            ratio2 = ((m_spawnerDoorTimer2 - closeStartTime) / (m_spawnerDoorSwingTimeMax - closeStartTime));
            ratio2 = 1.0f - ratio2;
    ...
    if (m_altSpawnerAng2 < 0.0f)
    {
        m_altSpawnerAng2 = 0.0f;
    }
    ...
    m_spawnerBlastShieldRatio2 = blastShieldRatio2;

    angle1 = m_spawnerDoorAngleMax * ratio1;
    angle1 = smoothAng1;
    ...
    const float armOffsetUpperY = m_spawnerArmDimensions.y + (m_spawnerArmDimensions.y * 1.0f) + (m_spawnerExtendorDimensions.y * 0.5f);
    const float armOffsetZ = m_spawnerArmExtendedCombinedBase - (m_spawnerExtendorDimensions.z * 0.5f);

    m_spawnerExtenderDoorMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderDoorMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, m_spawnerArmExtendedCombinedBase + extenderMod1));
    m_spawnerExtenderDoorMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle1);
    m_spawnerExtenderDoorMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderUpperPortMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderUpperPortMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendorDimensions);
    m_spawnerExtenderUpperPortMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(armOffsetX, armOffsetUpperY, armOffsetZ + extenderMod1));
    m_spawnerExtenderUpperPortMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle1);
    m_spawnerExtenderUpperPortMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderLowerPortMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderLowerPortMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendorDimensions);
    ...
    m_spawnerExtenderUpperStarMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(-armOffsetX, armOffsetUpperY, armOffsetZ + extenderMod1));
    m_spawnerExtenderUpperStarMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle1);
    m_spawnerExtenderUpperStarMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderLowerStarMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderLowerStarMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendorDimensions);
    ...
    const float angRat1 = (extenderMod1 / circumference) * (2.0f * Utility::GetPi());
    m_spawnerExtenderGearStarMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendGearScale);
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateRotationZ(angRat1);
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerExtendGearOffsetX, m_spawnerExtendGearOffsetY, -m_spawnerExtendGearOffsetZ));
    m_spawnerExtenderGearStarMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderGearPortMat1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderGearPortMat1 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendGearScale);
    m_spawnerExtenderGearPortMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerExtenderGearPortMat1 *= DirectX::SimpleMath::Matrix::CreateRotationZ(angRat1);
    m_spawnerExtenderGearPortMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(-m_spawnerExtendGearOffsetX, m_spawnerExtendGearOffsetY, m_spawnerExtendGearOffsetZ));
    m_spawnerExtenderGearPortMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    const float angRat2 = (extenderMod2 / circumference) * (2.0f * Utility::GetPi());
    m_spawnerExtenderGearStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendGearScale);
    m_spawnerExtenderGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerExtenderGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationZ(-angRat2);
    m_spawnerExtenderGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerExtendGearOffsetX, m_spawnerExtendGearOffsetY, m_spawnerExtendGearOffsetZ));
    m_spawnerExtenderGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderGearPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendGearScale);
    m_spawnerExtenderGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerExtenderGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationZ(-angRat2);
    m_spawnerExtenderGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerExtendGearOffsetX, m_spawnerExtendGearOffsetY, -m_spawnerExtendGearOffsetZ));
    m_spawnerExtenderGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // dual main axel
    /*
    const float angRatMainGear = m_spawnerDatatMainAxelAngle2;
    m_spawnerMainGearStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationZ(-angRatMainGear);
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerMainGearOffsetX, m_spawnerMainGearOffsetY, m_spawnerMainGearOffsetZ));
    m_spawnerMainGearStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    ...
    m_spawnerMainGearPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationZ(-angRatMainGear);
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(
        DirectX::SimpleMath::Vector3(m_spawnerMainGearOffsetX, m_spawnerMainGearOffsetY, -m_spawnerMainGearOffsetZ));
    m_spawnerMainGearPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    */
    // door 2 arms
    m_spawnerExtenderUpperPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderUpperPortMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendorDimensions);
    m_spawnerExtenderUpperPortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(-armOffsetX, armOffsetUpperY, -armOffsetZ - extenderMod2));
    m_spawnerExtenderUpperPortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle2);
    m_spawnerExtenderUpperPortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderLowerPortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderLowerPortMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendorDimensions);
    ...
    m_spawnerExtenderUpperStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(armOffsetX, armOffsetUpperY, -armOffsetZ - extenderMod2));
    m_spawnerExtenderUpperStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle2);
    m_spawnerExtenderUpperStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    m_spawnerExtenderLowerStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerExtenderLowerStarMat2 *= DirectX::SimpleMath::Matrix::CreateScale(m_spawnerExtendorDimensions);
    ...
    DirectX::SimpleMath::Vector3 armBasePos1 = DirectX::SimpleMath::Vector3::Zero;
    armBasePos1 = DirectX::SimpleMath::Vector3::Transform(armBasePos1, m_spawnerArmBaseStarMat1);
    armBasePos1.x = 0.0f;
    ...
    armBasePos1 = DirectX::SimpleMath::Vector3::Transform(armBasePos1, DirectX::SimpleMath::Matrix::CreateWorld(pos, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY));
    ...
    m_spawnerArmBaseStarMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerArmBaseStarMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(
        -m_spawnerArmBaseTransPreVec.x, m_spawnerArmBaseTransPreVec.y, -m_spawnerArmBaseTransPreVec.z));
    m_spawnerArmBaseStarMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle2);
    DirectX::SimpleMath::Vector3 armBasePos2 = DirectX::SimpleMath::Vector3::Zero;
    armBasePos2 = DirectX::SimpleMath::Vector3::Transform(armBasePos2, m_spawnerArmBaseStarMat2);
    armBasePos2.x = 0.0f;
    m_spawnerArmBaseStarMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(pos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);
    armBasePos2 = DirectX::SimpleMath::Vector3::Transform(armBasePos2, DirectX::SimpleMath::Matrix::CreateWorld(pos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY));

    // arm base port 2
    m_spawnerArmBasePortMat2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerArmBasePortMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(
        m_spawnerArmBaseTransPreVec.x, m_spawnerArmBaseTransPreVec.y, -m_spawnerArmBaseTransPreVec.z));
    m_spawnerArmBasePortMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle2);
    m_spawnerArmBasePortMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(pos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    // shadows
    // door shadows
    auto doorPos1 = m_spawnerMainAxelPos1;
    doorPos1.z += -m_spawnerArmExtendedCombinedBase - extenderMod1;

    auto doorMat1 = DirectX::SimpleMath::Matrix::Identity;
    doorPos1 = DirectX::SimpleMath::Vector3::Zero;
    doorMat1 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, m_spawnerArmExtendedCombinedBase + extenderMod1));
    doorMat1 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle1);
    doorMat1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos1, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);

    doorPos1 = DirectX::SimpleMath::Vector3::Zero;
    doorPos1 = DirectX::SimpleMath::Vector3::Transform(doorPos1, doorMat1);

    DirectX::SimpleMath::Vector3 lightDir = m_spawnerLightDirection1;
    DirectX::SimpleMath::Plane groundPlane;
    m_environment->GetGroundPlane(groundPlane, doorPos1);

    DirectX::SimpleMath::Vector3 zFightOffSet = groundPlane.Normal() * m_spawnerZOffSet;
    ...
    // shadow test
    auto lightDir1 = doorPos1 - m_spawnerLightPos1;
    lightDir1.Normalize();
    lightDir1 = armBasePos1 - m_spawnerLightPos1;
    lightDir1.x = 0.0f;
    lightDir1.Normalize();
    auto zOffSetMat = DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, m_spawnerZOffSet, 0.0f));

    DirectX::SimpleMath::Plane shadowPlane;
    m_environment->GetGroundPlane(shadowPlane, doorPos1);
    auto shadowTestMat = DirectX::SimpleMath::Matrix::Identity;
    shadowTestMat = m_spawnerExtenderDoorMat1;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, -m_spawnerShadowDoorOffset));
    ...
    // shadow gearbox 1 
    lightDir1 = m_spawnerGearboxPos1 - m_spawnerLightPos1;
    lightDir1.Normalize();
    ...
    lightDir1.x = 0.0f;
    lightDir1.Normalize();
    shadowTestMat = DirectX::SimpleMath::Matrix::Identity;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(100.0f, 1.0f, 100.0f));
    ...
    // door 2
    auto doorMat2 = DirectX::SimpleMath::Matrix::Identity;
    auto doorPos2 = DirectX::SimpleMath::Vector3::Zero;
    doorMat2 *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, -m_spawnerArmExtendedCombinedBase - extenderMod2));
    doorMat2 *= DirectX::SimpleMath::Matrix::CreateRotationX(m_spawnerDatatMainAxelAngle2);
    doorMat2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerMainAxelPos2, DirectX::SimpleMath::Vector3::UnitZ, DirectX::SimpleMath::Vector3::UnitY);
    doorPos2 = m_spawnerMainAxelPos2;
    doorPos2.z += m_spawnerArmExtendedCombinedBase + extenderMod2;
    doorPos2.y += 30.0F;
    doorPos2 = DirectX::SimpleMath::Vector3::Zero;
    doorPos2 = DirectX::SimpleMath::Vector3::Transform(doorPos2, doorMat2);
    m_environment->GetGroundPlane(shadowPlane, doorPos2);
    shadowTestMat = m_spawnerExtenderDoorMat2;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateTranslation(DirectX::SimpleMath::Vector3(0.0f, 0.0f, m_spawnerShadowDoorOffset));
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateShadow(lightDir2, shadowPlane);
    shadowTestMat *= zOffSetMat;
    m_spawnerExtenderDoorShadowMat2 = shadowTestMat;

    // shadow base arm starbord 1 
    lightDir1 = armBasePos1 - m_spawnerLightPos1;
    lightDir1.x = 0.0f;
    lightDir1.Normalize();
    shadowTestMat = DirectX::SimpleMath::Matrix::Identity;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(1.0f, 1.0f, 1.4f));
    shadowTestMat *= m_spawnerArmBaseStarMat1;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateShadow(lightDir1, shadowPlane);
    shadowTestMat *= zOffSetMat;
    m_spawnerBaseArmStarShadowMat1 = shadowTestMat;

    // shadow base arm port 1 
    shadowTestMat = DirectX::SimpleMath::Matrix::Identity;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(1.0f, 1.0f, 1.4f));
    shadowTestMat *= m_spawnerArmBasePortMat1;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateShadow(lightDir1, shadowPlane);
    shadowTestMat *= zOffSetMat;
    m_spawnerBaseArmPortShadowMat1 = shadowTestMat;

    // shadow base arm port 2
    lightDir2 = armBasePos2 - m_spawnerLightPos2;
    lightDir2.x = 0.0f;
    lightDir2.Normalize();
    shadowTestMat = DirectX::SimpleMath::Matrix::Identity;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(1.0f, 1.0f, 1.4f));
    shadowTestMat *= m_spawnerArmBasePortMat2;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateShadow(lightDir2, shadowPlane);
    shadowTestMat *= zOffSetMat;
    m_spawnerBaseArmPortShadowMat2 = shadowTestMat;
    // shadow base arm star 2
    shadowTestMat = DirectX::SimpleMath::Matrix::Identity;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(1.0f, 1.0f, 1.4f));
    shadowTestMat *= m_spawnerArmBaseStarMat2;
    shadowTestMat *= DirectX::SimpleMath::Matrix::CreateShadow(lightDir2, shadowPlane);
    shadowTestMat *= zOffSetMat;
    m_spawnerBaseArmStarShadowMat2 = shadowTestMat;

    /// blast doors
    m_spawnerBaseBlastScaledMat1 = m_spawnerBaseBlastMat1;
    const float blastScale = m_spawnerBlastShieldRatio1 * m_spawneBlastShieldExtendMod;
    m_spawnerBaseBlastScaledMat1 *= DirectX::SimpleMath::Matrix::CreateScale(
        DirectX::SimpleMath::Vector3(1.0f - (blastScale * 0.1f), 0.92f - (blastScale * 0.35f), 1.0f - (blastScale * 0.1f)));
    m_spawnerBaseBlastScaledMat1 *= m_spawnerBaseBlastMatPost1;

    const float blastScale2 = m_spawnerBlastShieldRatio2 * m_spawneBlastShieldExtendMod;
    m_spawnerBaseBlastScaledMat2 = m_spawnerBaseBlastMat2;
    m_spawnerBaseBlastScaledMat2 *= DirectX::SimpleMath::Matrix::CreateScale(
        DirectX::SimpleMath::Vector3(1.0f - (blastScale2 * 0.1f), 0.92f - (blastScale2 * 0.35f), 1.0f - (blastScale2 * 0.1f)));
    m_spawnerBaseBlastScaledMat2 *= m_spawnerBaseBlastMatPost2;

    // axel 2 spawner 1
    m_spawnerAxel2Spawner1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerAxel2Spawner1 *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(0.5f, 0.98f, 0.5f));
    m_spawnerAxel2Spawner1 *= DirectX::SimpleMath::Matrix::CreateRotationY(-m_spawnerDatatMainAxelAngle1 * 2.0f);
    m_spawnerAxel2Spawner1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerAxel2Spawner1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerAxel2PosSpawner1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    // axel 2 spawner 2
    m_spawnerAxel2Spawner2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerAxel2Spawner2 *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(0.5f, 0.98f, 0.5f));
    m_spawnerAxel2Spawner2 *= DirectX::SimpleMath::Matrix::CreateRotationY(-m_spawnerDatatMainAxelAngle2 * 2.0f);
    m_spawnerAxel2Spawner2 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerAxel2Spawner2 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerAxel2PosSpawner2, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);

    // axel 3 spawner 1
    m_spawnerAxel3Spawner1 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerAxel3Spawner1 *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(0.25f, 1.02f, 0.25f));
    m_spawnerAxel3Spawner1 *= DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle1 * 4.0f);
    m_spawnerAxel3Spawner1 *= DirectX::SimpleMath::Matrix::CreateRotationX(Utility::ToRadians(90.0f));
    m_spawnerAxel3Spawner1 *= DirectX::SimpleMath::Matrix::CreateWorld(m_spawnerAxel3PosSpawner1, DirectX::SimpleMath::Vector3::UnitX, DirectX::SimpleMath::Vector3::UnitY);
    // axel 3 spawner 2
    m_spawnerAxel3Spawner2 = DirectX::SimpleMath::Matrix::Identity;
    m_spawnerAxel3Spawner2 *= DirectX::SimpleMath::Matrix::CreateScale(DirectX::SimpleMath::Vector3(0.25f, 1.02f, 0.25f));
    m_spawnerAxel3Spawner2 *= DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2 * 4.0f);
...
void Game::DrawSpawner()
{
    ...
    if (m_isSpawnerLightOn1 == true)
    {
        ...
        m_effect->SetLightEnabled(1, true);
        m_effect->SetLightEnabled(2, true);
        //m_effect->SetLightDiffuseColor(2, m_spawnerColorLightOn);
       // m_effect->SetLightSpecularColor(2, m_spawnerColorLightOn);
        m_effect->SetSpecularColor(m_spawnerColorLightOn);
    }
    else
    {
        m_effect->DisableSpecular();
    ...
    m_effect->SetWorld(m_spawnerLightHousingMat1Pos1);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightHousingMat1Pos2);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightHousingMat1Pos3);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightHousingMat1Pos4);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    /*
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat1Pos1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat1Pos2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat1Pos3, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat1Pos4, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    */
    //m_effect->SetLightEnabled(2, true);
    //m_effect->SetLightDirection(2, m_spawnerLightDirection1);
...
/////////////////////////
    ...
    auto lightDir1 = m_spawnerPos - m_spawnerLightPos1;

    lightDir1.x = 0.0f;
    lightDir1.Normalize();

    //lightDir1 = DirectX::SimpleMath::Vector3(0.0f, -1.0f, 0.5f);
    //lightDir1.Normalize();

    m_effect->SetLightDirection(0, lightDir1);
    m_effect->SetLightDirection(0, m_spawnerLightDirection1);

    m_effect->SetWorld(m_spawnerBaseMat1);
    m_effect->SetColorAndAlpha(m_spawnerColorBlastWindowInterior);
    m_spawnerBaseShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    {
        /*
        m_effect->SetColorAndAlpha(m_spawnerColorLightOn);
        m_effect->SetWorld(m_spawnerLightInnerMat1Pos1);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

        m_effect->SetWorld(m_spawnerLightInnerMat1Pos2);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

        m_effect->SetWorld(m_spawnerLightInnerMat1Pos3);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

        m_effect->SetWorld(m_spawnerLightInnerMat1Pos4);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());
        */
    ...
    {
        m_effect->SetColorAndAlpha(m_spawnerColorLightOff);
        m_effect->SetWorld(m_spawnerLightInnerMat1Pos1);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightRingMat1Pos2);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightRingMat1Pos3);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightRingMat1Pos4);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    /*
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat1Pos1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat1Pos2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat1Pos3, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat1Pos4, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    */

    lightDir1 = m_spawnerPos - m_spawnerLightPos1;
    lightDir1.x = 0.0f;
    lightDir1.Normalize();
    m_effect->SetLightDirection(0, lightDir1);
    m_effect->SetWorld(m_spawnerOuterMat);
    m_effect->SetColorAndAlpha(m_spawnerColorShell);
    m_spawnerOuterShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetLightDirection(0, m_spawnerLightDirection1);

    m_effect->SetWorld(m_spawnerExtenderUpperPortMat1);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerExtenderLowerPortMat1);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerExtenderUpperStarMat1);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    m_effect->SetWorld(m_spawnerExtenderHousePortMat1);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerExtenderHouseStarMat1);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    //m_shapeNormCube->Draw(m_spawnerExtenderHousePortMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorGearBox);
    //m_shapeNormCube->Draw(m_spawnerExtenderHouseStarMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorGearBox);

    // extender gear 1
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderGear);
    m_effect->SetWorld(m_spawnerExtenderGearPortMat1);
    m_shapeNormCylinderGear->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerExtenderGearStarMat1);
    m_shapeNormCylinderGear->Draw(m_effect.get(), m_inputLayout.Get());
    //m_shapeNormCylinderGear->Draw(m_spawnerExtenderGearPortMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderGear);
    //m_shapeNormCylinderGear->Draw(m_spawnerExtenderGearStarMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderGear);
     // extender axel 1
    m_effect->SetColorAndAlpha(m_spawnerColorAxelShaft);
    m_effect->SetWorld(m_spawnerExtenderGearPortMat1);
    m_shapeNormCylinderAxel->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerExtenderGearStarMat1);
    m_shapeNormCylinderAxel->Draw(m_effect.get(), m_inputLayout.Get());
    //m_shapeNormCylinderAxel->Draw(m_spawnerExtenderGearPortMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);
    //m_shapeNormCylinderAxel->Draw(m_spawnerExtenderGearStarMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);

    // base arm
    m_effect->SetColorAndAlpha(m_spawnerColorBaseArm);
    m_effect->SetWorld(m_spawnerArmBasePortMat1);
    m_spawnerArmShape->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerArmBaseStarMat1);
    m_spawnerArmShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // gearbox
    m_effect->SetColorAndAlpha(m_spawnerColorGearBox);
    m_effect->SetWorld(m_spawnerGearBoxMat1);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    //m_shapeNormCube->Draw(m_spawnerGearBoxMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorGearBox);
    // main axel core
    m_effect->SetColorAndAlpha(m_spawnerColorAxelCore1);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle1) * m_spawnerMainAxelMat1);
    m_spawnerAxelShape->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerAxelShape->Draw(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle1)* m_spawnerMainAxelMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelCore1);
     // main axel 1
    m_effect->SetColorAndAlpha(m_spawnerColorAxel1);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle1) * m_spawnerMainAxelMat1);
    m_spawnerAxelShape2->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerAxelShape2->Draw(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle1)* m_spawnerMainAxelMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxel1);
    // second axel 1
    m_effect->SetColorAndAlpha(m_spawnerColorAxel2);
    m_effect->SetWorld(m_spawnerAxel2Spawner1);
    m_spawnerAxelShape2->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerAxelShape2->Draw(m_spawnerAxel2Spawner1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxel2);
    // thrid axel 1
    m_effect->SetColorAndAlpha(m_spawnerColorAxel3);
    m_effect->SetWorld(m_spawnerAxel3Spawner1);
    m_spawnerAxelShape3->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerAxelShape3->Draw(m_spawnerAxel3Spawner1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxel3);

    // axel shafts
    m_effect->SetColorAndAlpha(m_spawnerColorAxelShaft);
    m_effect->SetWorld(m_spawnerAxel2Spawner1);
    m_spawnerAxelShaftShape->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerAxel3Spawner1);
    m_spawnerAxelShaftShape->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerAxelShaftShape->Draw(m_spawnerAxel2Spawner1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);
    //m_spawnerAxelShaftShape->Draw(m_spawnerAxel3Spawner1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);
    ...
    ///////////
    lightDir1 = m_spawnerLightDirection1;
    m_effect->SetLightDirection(0, lightDir1);
    m_effect->SetWorld(m_spawnerExtenderDoorMat1);
    m_effect->SetColorAndAlpha(m_spawnerColorDoor);
    m_spawnerDoorShape->Draw(m_effect.get(), m_inputLayout.Get());

    // backside lighting needed
    // old style start
    ...
    //m_effect->SetSpecularColor(DirectX::Colors::Yellow);

    // blast windows bars
    m_effect->SetColorAndAlpha(m_spawnerColorBlastWindowBars);
    m_effect->SetWorld(m_spawnerBlastWindowBarPortMat1);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerBlastWindowBarStarMat1);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    //m_shapeNormCube->Draw(m_spawnerBlastWindowBarPortMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorBlastWindowBars);
    //m_shapeNormCube->Draw(m_spawnerBlastWindowBarStarMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorBlastWindowBars);
    // blast window
    m_effect->SetColorAndAlpha(m_spawnerColorBlastWindowDeploy);
    m_effect->SetWorld(m_spawnerBaseBlastScaledMat1);
    m_spawnerBaseShape->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerBaseShape->Draw(m_spawnerBaseBlastScaledMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorBlastWindowDeploy);
    // 1
    // extras from old
    // roof 1 
    m_effect->SetColorAndAlpha(m_spawnerColorRoof);
    m_effect->SetWorld(m_spawnerBaseRoofMat1);
    m_spawnerBaseRoofShape->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerBaseRoofShape->Draw(m_spawnerBaseRoofMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorRoof);
    // lower base 1
    m_effect->SetColorAndAlpha(m_spawnerColorStackFirstFloor);
    m_effect->SetWorld(m_spawnerBaseLowerMat1);
    m_spawnerBaseRoofShape->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerBaseRoofShape->Draw(m_spawnerBaseLowerMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorStackFirstFloor);
    // rear base second floor 1
    m_effect->SetColorAndAlpha(m_spawnerColorStackSecondFloor);
    m_effect->SetWorld(m_spawnerBaseRearMat1);
    m_spawnerBaseRoofShape->Draw(m_effect.get(), m_inputLayout.Get());
    m_spawnerBaseRoofShape->Draw(m_spawnerBaseRearMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorStackSecondFloor);

    // inner back shadow1
    m_effect->SetColorAndAlpha(m_spawnerColorInterior);
    m_effect->SetWorld(m_spawnerInnerBackShadowMat1);
    //m_spawnerInnerBackShadowShape->Draw(m_effect.get(), m_inputLayout.Get());
    m_spawnerInnerBackShadowShape->Draw(m_spawnerInnerBackShadowMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorInterior);
    ...
    if (m_isSpawnerLightOn1 == true)
    {
        ...
        m_spawnerArmShape->Draw(m_spawnerBaseArmStarShadowMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorShadow);
        m_spawnerArmShape->Draw(m_spawnerBaseArmPortShadowMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorShadow);
    }

    // shell interiors
    if (m_isSpawnerLightOn1 == true && m_spawnerDoorTimer1 < m_spawnerDoorSwingTimeMax * m_spawnerIntiorLightCutOffMod)
    {
        const float modVal = m_spawnerDoorTimer1 / (m_spawnerDoorSwingTimeMax * m_spawnerIntiorLightCutOffMod);
        const float invsMod = 1.0f - modVal;

        m_spawnerInteriorLightAngle0Spawner1 = Utility::WrapAnglePositive(m_spawnerInteriorLightAngle0Spawner1 + m_spawnerInteriorLightAngleFrequencyMod);
        m_spawnerInteriorLightAngle1Spawner1 = Utility::WrapAnglePositive(m_spawnerInteriorLightAngle1Spawner1 + m_spawnerInteriorLightAngleFrequencyMod);
        m_spawnerInteriorLightAngle2Spawner1 = Utility::WrapAnglePositive(m_spawnerInteriorLightAngle2Spawner1 + m_spawnerInteriorLightAngleFrequencyMod);
        ...
        m_effect->SetLightDirection(0, lightDir0);
        m_effect->SetLightDirection(1, lightDir1);
        m_effect->SetLightDirection(2, lightDir2);
        m_effect->SetLightEnabled(0, true);
        m_effect->SetLightEnabled(1, true);
        m_effect->SetLightEnabled(2, true);
        m_effect->SetSpecularColor(DirectX::Colors::Red * invsMod);
        m_effect->SetLightDiffuseColor(0, DirectX::Colors::Yellow * invsMod);
        m_effect->SetLightDiffuseColor(1, DirectX::Colors::Yellow * invsMod);
        m_effect->SetLightDiffuseColor(2, DirectX::Colors::Yellow * invsMod);
    }
    else
    {
        m_effect->EnableDefaultLighting();
    ...
    m_effect->SetColorAndAlpha(m_spawnerColorInterior);
    m_effect->SetWorld(m_spawnerShellInteriorMat1);
    m_spawnerOuterShape->Draw(m_effect.get(), m_inputLayout.Get());
    //m_spawnerOuterShape->Draw(m_spawnerShellInteriorMat1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorInterior);
    ...
    mainLightDirection1 = DirectX::SimpleMath::Vector3(0.0f, -1.0f, -0.5f);
    mainLightDirection1.Normalize();
    mainLightDirection2 = m_spawnerLightDirection2;
    m_effect->SetLightDirection(0, mainLightDirection0);
    m_effect->SetLightDirection(1, mainLightDirection1);
    ...
    m_effect->SetWorld(m_spawnerOuterMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorShell);
    m_spawnerOuterShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerBaseMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorBlastWindowInterior);
    m_spawnerBaseShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_shapeNormCube->Draw(m_spawnerBlastWindowBarPortMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorBlastWindowBars);
    m_shapeNormCube->Draw(m_spawnerBlastWindowBarStarMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorBlastWindowBars);

    // shell interiors
    m_spawnerOuterShape->Draw(m_spawnerShellInteriorMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorInterior);
    // light bars
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat2Pos1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat2Pos2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat2Pos3, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_shapeNormCylinder->Draw(m_spawnerLightHousingMat2Pos4, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);

    if (m_isSpawnerLightOn2 == true)
    {
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOn);
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOn);
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos3, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOn);
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos4, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOn);
    }
    else
    {
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOff);
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOff);
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos3, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOff);
        m_shapeNormCylinder->Draw(m_spawnerLightInnerMat2Pos4, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightOff);
    }

    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat2Pos1, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat2Pos2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat2Pos3, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);
    m_spawnerLightRingShape->Draw(m_spawnerLightRingMat2Pos4, m_camera->GetViewMatrix(), m_proj, m_spawnerColorLightHousing);

    m_shapeNormCube->Draw(m_spawnerExtenderUpperPortMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_spawnerExtenderLowerPortMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderArm);

    m_shapeNormCube->Draw(m_spawnerExtenderUpperStarMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_spawnerExtenderLowerStarMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderArm);

    m_effect->SetWorld(m_spawnerExtenderDoorMat2);
    ...
    if (m_isSpawnerLightOn2 == true)
    {
        ...
        m_spawnerArmShape->Draw(m_spawnerBaseArmStarShadowMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorShadow);
        m_spawnerArmShape->Draw(m_spawnerBaseArmPortShadowMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorShadow);
    }

    // extender housing
    m_shapeNormCube->Draw(m_spawnerExtenderHousePortMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorGearBox);
    m_shapeNormCube->Draw(m_spawnerExtenderHouseStarMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorGearBox);
    m_shapeNormCylinderGear->Draw(m_spawnerExtenderGearPortMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderGear);
    m_shapeNormCylinderGear->Draw(m_spawnerExtenderGearStarMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorExtenderGear);
    m_shapeNormCylinderAxel->Draw(m_spawnerExtenderGearPortMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);
    m_shapeNormCylinderAxel->Draw(m_spawnerExtenderGearStarMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);

    m_spawnerBaseRoofShape->Draw(m_spawnerBaseRoofMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorRoof);
    m_spawnerBaseRoofShape->Draw(m_spawnerBaseLowerMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorStackFirstFloor);
    ...
    m_spawnerBaseShape->Draw(m_spawnerBaseBlastScaledMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorBlastWindowDeploy);
    m_shapeNormCube->Draw(m_spawnerGearBoxMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorGearBox);

    m_spawnerAxelShape->Draw(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2) * m_spawnerMainAxelMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelCore1);
    m_spawnerAxelShape2->Draw(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2) * m_spawnerMainAxelMat2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxel1);

    m_spawnerAxelShape2->Draw(m_spawnerAxel2Spawner2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxel2);
    m_spawnerAxelShape3->Draw(m_spawnerAxel3Spawner2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxel3);

    m_spawnerAxelShaftShape->Draw(m_spawnerAxel2Spawner2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);
    m_spawnerAxelShaftShape->Draw(m_spawnerAxel3Spawner2, m_camera->GetViewMatrix(), m_proj, m_spawnerColorAxelShaft);

    m_effect->SetSpecularColor(m_spawnerColorLightOff);
}

void Game::DrawSpawner1()
{
    // spawner 1
    m_effect->EnableDefaultLighting();
    auto mainLightDirection0 = m_spawnerLightDirection1;
...
void Game::DrawSpawner1to2()
{
    ...
    mainLightDirection0.Normalize();
    auto mainLightDirection1 = DirectX::SimpleMath::Vector3(1.0f, -0.1f, 0.0f);
    mainLightDirection1.Normalize();
    auto mainLightDirection2 = DirectX::SimpleMath::Vector3(-1.0f, 0.3f, 0.0f);
    mainLightDirection2.Normalize();
    ...
    if (m_isSpawnerLightOn2 == true)
    {
        ...
        //mainLightDirection1.Normalize();
        //m_effect->SetLightDirection(1, mainLightDirection1);
        m_effect->SetLightDirection(1, -m_spawnerLightDirection2);
        //m_effect->DisableSpecular();
        m_effect->SetLightEnabled(0, true);
        m_effect->SetLightEnabled(1, true);
        m_effect->SetLightEnabled(2, true);
    ...
    m_effect->SetColorAndAlpha(m_spawnerColorLightHousing);
    m_effect->SetWorld(m_spawnerLightHousingMat2Pos1);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightHousingMat2Pos2);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightHousingMat2Pos3);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightHousingMat2Pos4);
    m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

    // base
    auto lightDir1 = m_spawnerPos2 - m_spawnerLightPos2;
    lightDir1.x = 0.0f;
    lightDir1.Normalize();
    m_effect->SetLightDirection(0, lightDir1);
    m_effect->SetLightDirection(0, m_spawnerLightDirection2);
    ...
    if (m_isSpawnerLightOn2 == true)
    {
        ...
        */
        ...
        m_effect->SetColorAndAlpha(m_spawnerColorLightOn);
        m_effect->SetWorld(m_spawnerLightInnerMat2Pos1);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

        m_effect->SetWorld(m_spawnerLightInnerMat2Pos2);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

        m_effect->SetWorld(m_spawnerLightInnerMat2Pos3);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());

        m_effect->SetWorld(m_spawnerLightInnerMat2Pos4);
        m_shapeNormCylinder->Draw(m_effect.get(), m_inputLayout.Get());
    }
    else
    {
    ...
    m_effect->SetColorAndAlpha(m_spawnerColorLightHousing);
    m_effect->SetWorld(m_spawnerLightRingMat2Pos1);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightRingMat2Pos2);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightRingMat2Pos3);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerLightRingMat2Pos4);
    m_spawnerLightRingShape->Draw(m_effect.get(), m_inputLayout.Get());

    lightDir1 = m_spawnerPos2 - m_spawnerLightPos2;
    lightDir1.x = 0.0f;
    lightDir1.Normalize();
    m_effect->SetLightDirection(0, lightDir1);
    m_effect->SetWorld(m_spawnerOuterMat2);
    ...
    m_effect->SetWorld(m_spawnerExtenderUpperPortMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerExtenderLowerPortMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerExtenderUpperStarMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetWorld(m_spawnerExtenderLowerStarMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderArm);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    // extender housing 2
    m_effect->SetColorAndAlpha(m_spawnerColorGearBox);
    m_effect->SetWorld(m_spawnerExtenderHousePortMat2);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerExtenderHouseStarMat2);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    // extender gear 1
    m_effect->SetColorAndAlpha(m_spawnerColorExtenderGear);
    m_effect->SetWorld(m_spawnerExtenderGearPortMat2);
    m_shapeNormCylinderGear->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerExtenderGearStarMat2);
    m_shapeNormCylinderGear->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // base arm
    m_effect->SetColorAndAlpha(m_spawnerColorBaseArm);
    m_effect->SetWorld(m_spawnerArmBasePortMat2);
    m_spawnerArmShape->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerArmBaseStarMat2);
    m_spawnerArmShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // gearbox
    m_effect->SetColorAndAlpha(m_spawnerColorGearBox);
    m_effect->SetWorld(m_spawnerGearBoxMat2);
    //m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    // gearbox dual
    m_effect->SetColorAndAlpha(m_spawnerColorGearBox);
    m_effect->SetWorld(m_spawnerGearBoxPortMat2);
    m_shapeGearbox->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetColorAndAlpha(m_spawnerColorGearBox);
    m_effect->SetWorld(m_spawnerGearBoxStarMat2);
    m_shapeGearbox->Draw(m_effect.get(), m_inputLayout.Get());

    // dual main axel
    m_effect->SetColorAndAlpha(m_spawnerColorAxel1);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2) * m_spawnerMainGearPortMat2);
    m_spawnerMainAxelShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetColorAndAlpha(m_spawnerColorAxel1);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2) * m_spawnerMainGearStarMat2);
    m_spawnerMainAxelShape->Draw(m_effect.get(), m_inputLayout.Get());

    // main axel core
    m_effect->SetColorAndAlpha(m_spawnerColorAxelCore1);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2) * m_spawnerMainAxelMat2);
    // m_spawnerAxelShape->Draw(m_effect.get(), m_inputLayout.Get());

    m_effect->SetColorAndAlpha(m_spawnerColorAxelCore1);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY(m_spawnerDatatMainAxelAngle2) * m_spawnerMainGearPortMat2);
    m_spawnerMainAxelCoreShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // second dual axel
    m_effect->SetColorAndAlpha(m_spawnerColorAxel2);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY((-m_spawnerDatatMainAxelAngle2 * 2.0f)) * m_spawnerSecondGearStarMat2);
    m_spawnerAxelDualShape2->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetColorAndAlpha(m_spawnerColorAxelShaft);
    m_spawnerAxelCoreDualShape2->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetColorAndAlpha(m_spawnerColorAxel2);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY((-m_spawnerDatatMainAxelAngle2 * 2.0f)) * m_spawnerSecondGearPortMat2);
    m_spawnerAxelDualShape2->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetColorAndAlpha(m_spawnerColorAxelShaft);
    m_spawnerAxelCoreDualShape2->Draw(m_effect.get(), m_inputLayout.Get());
    // third dual axel
    m_effect->SetColorAndAlpha(m_spawnerColorAxel3);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY((m_spawnerDatatMainAxelAngle2 * 4.0f)) * m_spawnerThirdGearStarMat2);
    m_spawnerAxelDualShape3->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetColorAndAlpha(m_spawnerColorAxelShaft);
    m_spawnerAxelCoreDualShape3->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetColorAndAlpha(m_spawnerColorAxel3);
    m_effect->SetWorld(DirectX::SimpleMath::Matrix::CreateRotationY((m_spawnerDatatMainAxelAngle2 * 4.0f)) * m_spawnerThirdGearPortMat2);
    m_spawnerAxelDualShape3->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetColorAndAlpha(m_spawnerColorAxelShaft);
    m_spawnerAxelCoreDualShape3->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // second axel 1
    m_effect->SetColorAndAlpha(m_spawnerColorAxel2);
    m_effect->SetWorld(m_spawnerAxel2Spawner2);
    //m_spawnerAxelShape2->Draw(m_effect.get(), m_inputLayout.Get());

    // third axel 1
    m_effect->SetColorAndAlpha(m_spawnerColorAxel3);
    m_effect->SetWorld(m_spawnerAxel3Spawner2);
    //m_spawnerAxelShape3->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    lightDir1 = m_spawnerLightDirection2;
    m_effect->SetLightDirection(0, lightDir1);
    m_effect->SetWorld(m_spawnerExtenderDoorMat2);
    m_effect->SetColorAndAlpha(m_spawnerColorDoor);
    m_spawnerDoorShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // blast windows bars
    m_effect->SetColorAndAlpha(m_spawnerColorBlastWindowBars);
    m_effect->SetWorld(m_spawnerBlastWindowBarPortMat2);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());
    m_effect->SetWorld(m_spawnerBlastWindowBarStarMat2);
    m_shapeNormCube->Draw(m_effect.get(), m_inputLayout.Get());

    // blast window
    m_effect->SetColorAndAlpha(m_spawnerColorBlastWindowDeploy);
    m_effect->SetWorld(m_spawnerBaseBlastScaledMat2);
    m_spawnerBaseShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // roof 1 
    m_effect->SetColorAndAlpha(m_spawnerColorRoof);
    m_effect->SetWorld(m_spawnerBaseRoofMat2);
    m_spawnerBaseRoofShape->Draw(m_effect.get(), m_inputLayout.Get());
    ...
    // shell interiors
    if (m_isSpawnerLightOn2 == true && m_spawnerDoorTimer2 < m_spawnerDoorSwingTimeMax * m_spawnerIntiorLightCutOffMod)
    {
        const float modVal = m_spawnerDoorTimer2 / (m_spawnerDoorSwingTimeMax * m_spawnerIntiorLightCutOffMod);
        const float invsMod = 1.0f - modVal;
        /// <summary>
        /// /
        /// Need to update with new variables
        /// </summary>
        m_spawnerInteriorLightAngle0Spawner1 = Utility::WrapAnglePositive(m_spawnerInteriorLightAngle0Spawner1 + m_spawnerInteriorLightAngleFrequencyMod);
        m_spawnerInteriorLightAngle1Spawner1 = Utility::WrapAnglePositive(m_spawnerInteriorLightAngle1Spawner1 + m_spawnerInteriorLightAngleFrequencyMod);
        m_spawnerInteriorLightAngle2Spawner1 = Utility::WrapAnglePositive(m_spawnerInteriorLightAngle2Spawner1 + m_spawnerInteriorLightAngleFrequencyMod);
...
void Game::DrawSpawner2()
{
    ...
    ////////////
    // spawner 2  lighting
    auto mainLightDirection0 = -DirectX::SimpleMath::Vector3::UnitY;
    auto mainLightDirection1 = DirectX::SimpleMath::Vector3(0.0f, -1.0f, -0.5f);
    mainLightDirection1.Normalize();
    auto mainLightDirection2 = m_spawnerLightDirection2;
    m_effect->SetLightDirection(0, mainLightDirection0);
    m_effect->SetLightDirection(1, mainLightDirection1);
    m_effect->SetLightDirection(2, mainLightDirection2);
...
void Game::DrawIntroScene()
{
   ...
   // const float finDeployDisplayDuration = m_fireControl->GetDemoMissileTimerMax() - m_fadeDuration;
    ...
    const float fadeOutStart3 = fadeInStart3 + startDisplayDuration - fadeDuration;
    const float fadeOutEnd3 = fadeInStart3 + startDisplayDuration;
    ...
    const float fadeOutStart6 = fadeInStart6 + topAttackDisplayDurartion;
    const float fadeOutEnd6 = fadeInStart6 + topAttackDisplayDurartion + fadeDuration;
    ...
    if (timeStamp > fadeInStart5 && timeStamp < fadeOutEnd5)
    {
        ...
        if (timerLocal < (slideTime * 1.0f))
        {
            ...
            m_effect->SetSpecularTexture(m_specularFinDeploy01.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy01.Get());
        }
        ...
        {
            m_effect->SetTexture(m_textureFinDeploy02.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy02.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy02.Get());
        }
        else if (timerLocal < (slideTime * 4.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy03.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy03.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy03.Get());
        }
        else if (timerLocal < (slideTime * 5.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy04.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy04.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy04.Get());
        }
        else if (timerLocal < (slideTime * 6.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy05.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy05.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy05.Get());
        }
        else if (timerLocal < (slideTime * 7.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy06.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy06.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy06.Get());
        }
        else if (timerLocal < (slideTime * 8.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy07.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy07.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy07.Get());
        }
        else if (timerLocal < (slideTime * 9.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy08.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy08.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy08.Get());
        }
        else if (timerLocal < (slideTime * 10.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy09.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy09.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy09.Get());
        }
        else if (timerLocal < (slideTime * 11.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy10.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy10.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy10.Get());
        }
        else if (timerLocal < (slideTime * 12.0f))
        {
            m_effect->SetTexture(m_textureFinDeploy11.Get());
            m_effect->SetSpecularTexture(m_specularFinDeploy11.Get());
            m_effect->SetNormalTexture(m_normalMapFinDeploy11.Get());
        }
        else
        {
            int testBreak = 0;
...
void Game::OnDeviceLost()
{
    ...
    m_textureFinDeploy01.Reset();
    m_specularFinDeploy01.Reset();
    m_normalMapFinDeploy01.Reset();
    m_textureFinDeploy02.Reset();
    m_specularFinDeploy02.Reset();
    m_normalMapFinDeploy02.Reset();
    m_textureFinDeploy03.Reset();
    m_specularFinDeploy03.Reset();
    m_normalMapFinDeploy03.Reset();
    m_textureFinDeploy04.Reset();
    m_specularFinDeploy04.Reset();
    m_normalMapFinDeploy04.Reset();
    m_textureFinDeploy05.Reset();
    m_specularFinDeploy05.Reset();
    m_normalMapFinDeploy05.Reset();
    m_textureFinDeploy06.Reset();
    m_specularFinDeploy06.Reset();
    m_normalMapFinDeploy06.Reset();
    m_textureFinDeploy07.Reset();
    m_specularFinDeploy07.Reset();
    m_normalMapFinDeploy07.Reset();
    m_textureFinDeploy08.Reset();
    m_specularFinDeploy08.Reset();
    m_normalMapFinDeploy08.Reset();
    m_textureFinDeploy09.Reset();
    m_specularFinDeploy09.Reset();
    m_normalMapFinDeploy09.Reset();
    m_textureFinDeploy10.Reset();
    m_specularFinDeploy10.Reset();
    m_normalMapFinDeploy10.Reset();
    m_textureFinDeploy11.Reset();
    m_specularFinDeploy11.Reset();
    m_normalMapFinDeploy11.Reset();
    ...
    m_spawnerAxelShaftShape.reset();
    m_spawnerDoorShape.reset();
    m_spawnerInnerBackShadowShape.reset();
