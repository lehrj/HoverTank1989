...
public:
    ...
    enum class SoundFxType
    {
        ...
        SOUNDFXTYPE_FIN_DEPLOY,
        SOUNDFXTYPE_GONG,
        SOUNDFXTYPE_LASER_HIT,
        SOUNDFXTYPE_LASER_LOCK_TONE,
        SOUNDFXTYPE_LASER_LOCK_TONE_DEMO,
        SOUNDFXTYPE_LASER_MISS,
        SOUNDFXTYPE_LASER_OFF,
        SOUNDFXTYPE_LASER_ON,
        //SOUNDFXTYPE_POOF,
        SOUNDFXTYPE_MISSILE_ROCKET,
        SOUNDFXTYPE_MISSILE_ROCKET_DEMO,
        SOUNDFXTYPE_RAVEN,
        SOUNDFXTYPE_RAVENALT,
        SOUNDFXTYPE_SHOTBANG,
        SOUNDFXTYPE_SHOTBANGALT1,
        SOUNDFXTYPE_SHOTBANGALT2,
        SOUNDFXTYPE_SHOTBANGALT3,
        SOUNDFXTYPE_SPAWNER1,
        SOUNDFXTYPE_SPAWNER2,
        SOUNDFXTYPE_SPAWNERLIGHTSON,
        SOUNDFXTYPE_SPAWNERLIGHTSOFF,
        SOUNDFXTYPE_VEHICLENPC,
        SOUNDFXTYPE_VEHICLEPLAYER,
        SOUNDFXTYPE_VEHICLEPLAYERHOVER,
        SOUNDFXTYPE_VEHICLEPLAYERHOVEROLD,
    };
